            ...
            <div class="edit_wrap">
                <div class="edit_text_wrap">
                    <form action="/admin/profile/edit_profile/{{$id}}" method="POST" enctype="multipart/form-data"
                        ...
                        <input class="edit_area" name="name" id="edit_title" value="{{$id != 0 ? $profile->name:""}}">

                        <label class="title_label" for="edit_title">会社名・役職 : </label>
                        <input class="edit_area" name="company" id="edit_title" value="{{$id != 0 ? $profile->company:""}}">
                        ...
                        <label class="title_label" for="edit_title">リンク名 : </label>
                        <input class="edit_area" name="link_name" id="edit_title" value="{{$id != 0 ? $profile->link_name:""}}">

                        <label class="title_label" for="edit_title">リンクURL : </label>
                        <input class="edit_area" name="link_url" id="edit_title" value="{{$id != 0 ? $profile->link_url:""}}">
