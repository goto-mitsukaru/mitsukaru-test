...
@section('title', 'MOVIE')
@section('content')
    @include('admin.movie.modal')
    @include('admin.movie.create')
                ...
                <div class="category_list">
                    <table>
                        <tr class="category_list_menu">
                            ...
                            <th class="category_list_btn" id="edit_lock_wrap">操作</th>
                        </tr>
                        @foreach($movie_list as $movie)
                            <tr class="category_list_menu">
                                ...
                                <td class="category_list_btn movie_list_btn" id="edit_lock_wrap">
                                    <form action="/admin/movie/status/{{ $movie->id }}" method="post">
                                        @csrf
                                        <button type="submit"
                                                name="status_id"
