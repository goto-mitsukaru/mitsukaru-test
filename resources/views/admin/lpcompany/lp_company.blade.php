    ...
    <div class="main_contents" id="main_contents_profile">
        ...
        <div class="container">
            <div class="bottom_list">
                <a class="add_btn" href="/admin/lp_company/edit_lp_company/0">新規追加</a>
            </div>
            <div class="list_wrap">
                <div class="table_list">
                    <table>
                        <tr>
                            ...
                            <th class="list_text" style="width: auto">企業理念</th>
                        ...
                        @foreach($company_list as $company)
                            <tr>
                                ...
                                <td class="left_text">{{ $company->slogan }}</td>
                                <td class="list_btn com_btn_wrap">
                                    <button class="edit_btn table_btn" style="background: #2b6d8f;" onclick="location.href='/admin/lp_company/edit_lp_company/{{$company->id}}'">編集</button>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <button class="delete_btn table_btn"
                                                                ...
                                                                formaction="/admin/lp_company/{{$company->id}}"
                                                                formtarget="_self"
